...
class MagicAnimate(torch.nn.Module):
    def __init__(self,
        ...
        *_, func_args = inspect.getargvalues(inspect.currentframe())
        ...
        self.appearance_encoder = UNet2DConditionModel.from_pretrained('/media/ehab/46EEC3E77E2602C67/Cyshield/magic-animate/pretrained_models/realistic-vision-v51',
                                                                       subfolder="unet")
